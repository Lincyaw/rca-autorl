...
const RCA_INSTRUCTION = [
  ...
  '',
  '## Queries Already Run',
  '- [the SQL statement, verbatim and complete, and in one clause what its result showed]',
  '',
  ...
  '',
  'Rules:',
  '- Preserve SQL statements verbatim and completely: a re-run query is a wasted step, and a submitted node must cite the statement that grounds it.',
